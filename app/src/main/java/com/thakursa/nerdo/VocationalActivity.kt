...
import com.thakursa.nerdo.databinding.ActivityVocationalBinding

class VocationalActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imageList = intArrayOf(
            R.drawable.building,
            R.drawable.automotive_services,
            R.drawable.cooking,
            R.drawable.dimploma,
            R.drawable.fitness,
            R.drawable.hairdressing,
        ...
        val nameList = arrayOf("Building", "Automotive Services", "Cooking", "Diploma", "Fitness", "Hair Dressing", "Hospitality")
        ...
        listAdapter = ListAdapter(this@VocationalActivity, dataArrayList)
        binding.listview.adapter = listAdapter
        binding.listview.isClickable = true

        binding.listview.onItemClickListener = OnItemClickListener { adapterView, view, i, l ->
            val intent = Intent(this@VocationalActivity, DetailedActivity::class.java)
